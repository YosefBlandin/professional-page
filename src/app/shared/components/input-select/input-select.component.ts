...
import { ControlValueAccessor, FormControl, FormControlDirective, FormControlName, FormGroupDirective, FormsModule, NG_VALIDATORS, NG_VALUE_ACCESSOR, NgControl, ReactiveFormsModule, ValidationErrors, Validator } from '@angular/forms';
...
@Component({
	selector: 'professional-page-input-select',
	standalone: true,
	imports: [FormsModule, MatFormFieldModule, MatSelectModule, MatInputModule, ReactiveFormsModule],
	providers: [{
...
export class InputSelectComponent implements OnInit, ControlValueAccessor, Validator {
	@Input() public label = '';
	...
	public getObjPropValue(obj: { [key: string]: string | number }, index?: number): string | number {
